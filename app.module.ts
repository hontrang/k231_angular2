...
import {ShopPageComponent} from "./module/shop-page/shop-page.component";
//Service
...
@NgModule({
  ...
  declarations: [AppComponent, HeaderComponent, MainmenuComponent, SiteBrandingComponent, FooterTopComponent, FooterBottomComponent,
    ...
    ProductBigTitleComponent, SingleShopProductComponent, ShopPageComponent,
    ...
    LoginPageComponent,SearchEngineComponent,BackToTopComponent,TopViewedComponent,ShoppingCartContentComponent],
